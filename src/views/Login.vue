<template>
<div class="zq-login-box">
    <div class="zq-login-div">
        <el-form ref="loginFormRef" :model="loginFormModel" :rules="loginFormRules">
            <div class="zq-login-title">欢迎登录</div>
            <el-form-item prop="username">
                <el-input v-model="loginFormModel.username" placeholder="请输入账号">
            ...
            <el-form-item>
                <el-button :loading="loading" class="zq-login-btn" style="width:100%;" @click.native.prevent="handleLogin">
